...
import and.fast.widget.image.preview.loader.ImageLoader;
import and.fast.widget.image.preview.style.IIndexIndicator;
import and.fast.widget.image.preview.style.IProgressIndicator;
...
public final class TransferConfig {
    ...
    public Drawable getMissDrawable(Context context) {
        if (missDrawable != null)
            ...
            return context.getResources().getDrawable(R.drawable.images_shape_empty_photo);
    }
